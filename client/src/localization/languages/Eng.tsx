...
export default {
  ...
  com_ui_example_quantum_computing: 'Explain product market fit in simple terms',
  com_ui_example_10_year_old_b_day: 'Got any creative ideas for a users dashboard?',
  ...
  com_ui_pay_per_call: 'All AI conversations in one place.',
  com_ui_enter: 'Enter',
